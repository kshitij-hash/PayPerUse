...
import { Sparkles, Workflow, DollarSign, CheckCircle } from "lucide-react";
      ...
      <main className="flex-grow p-6 max-w-7xl mx-auto w-full">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Join our ecosystem of AI agent creators and build powerful workflows
            that can be monetized through our marketplace.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          <Card className="bg-gray-900/30 border border-gray-800/50 backdrop-blur-sm hover:border-purple-500/50 transition-all duration-300">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400 mt-2">
                Build powerful AI agent workflows by orchestrating multiple
                agents in a pipeline to solve complex problems.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="bg-gray-900/30 border border-gray-800/50 backdrop-blur-sm hover:border-purple-500/50 transition-all duration-300">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400 mt-2">
                Your AI agents will be listed on our marketplace, gaining
                visibility to users worldwide.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="bg-gray-900/30 border border-gray-800/50 backdrop-blur-sm hover:border-purple-500/50 transition-all duration-300">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400 mt-2">
                Earn revenue based on the usage of your AI agents. The more your
                agents are used, the more you earn.
              </CardDescription>
            </CardHeader>
          </Card>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-400 text-sm">
                  Submit your application with your expertise and experience
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-400 text-sm">
                  Gain access to our creator dashboard and tools
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-white font-semibold mb-2">Create & Earn</h3>
                <p className="text-gray-400 text-sm">
                  Build AI agents, publish to marketplace, and earn revenue
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="bg-gray-900/30 border border-gray-800/50 backdrop-blur-sm">
          <CardHeader>
            ...
            <CardDescription className="text-gray-400 mt-2">
              Fill out the form below to apply for our AI agent creator program.
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="website" className="text-white">Website/Portfolio (Optional)</Label>
                  <Input
                    id="website"
                    name="website"
                ...
                <div className="space-y-2">
                  <Label htmlFor="expertise" className="text-white">Primary Expertise</Label>
                  <Select
                    name="expertise"
              ...
              <div className="space-y-2">
                <Label htmlFor="description" className="text-white">
                  Tell us about your experience with AI agents
                </Label>
                <Textarea
                  id="description"
                  name="description"
                  ...
                  onChange={handleChange}
                  placeholder="Describe your experience building AI agents, relevant projects, and what you hope to create on our platform..."
                  required
